...
Contoh `sendChatMediaFromUrl` (download URL lalu upload sebagai `file`):
...
Untuk `sendChatMediaFromUrl`, server file harus memberi `Content-Length` agar ukuran file diketahui.
